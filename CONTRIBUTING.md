...
## Report bugs using Github's [issues](https://github.com/Rishit-dagli/Visualize.AI/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/Rishit-dagli/Visualize.AI/issues); it's that easy!
